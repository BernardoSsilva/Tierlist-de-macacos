...
import { DndKitMonkey } from "./macaco-dnd";
...
export function DndKit() {
    const [macacos, setMacacos] = useState<Macaco[]>([
...

        {
            id: 36,
            name: "rei julien",
            imageSrc: "https://animecomics.com.br/images/upload/517.jpg",
        },

        {
            id: 37,
            name: "Ham (astronauta)",
            imageSrc: "https://upload.wikimedia.org/wikipedia/commons/c/c9/Ham_the_chimp_%28cropped%29.jpg",
        },

        {
            id: 38,
            name: "Macaco cheira dedo",
            imageSrc: "https://i.ytimg.com/vi/bygrod3t2Fk/mqdefault.jpg",
        },

        {
            id: 39,
            name: "Macaco sem medo da onça",
            imageSrc: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMq5jM9J7DBzblq549LWLHcxfsrShZPTZIqA&s",
        },

        {
            id: 40,
            name: "Macaco matador de leão",
            imageSrc: "https://i.redd.it/pl1mdmi7v4z31.jpg",
        },

        {
            id: 41,
            name: "Macaco do teorema do macaco infinito",
            imageSrc: "https://upload.wikimedia.org/wikipedia/commons/f/f1/Monkey-typing.jpg",
        },
